...
const PLACEHOLDER = "/placeholder-cookie.png";
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Discover our carefully curated selection of premium cookies and dry cakes,
                ...
                <Card className="h-full hover:shadow-lg transition-shadow duration-300 overflow-hidden group">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button
                      ...
                      onClick={() =>
                        product.inStock ? (window.location.href = "/contact") : null
                      }
